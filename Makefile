...
clean:
	rm -rf out/pkg
	rm -f out/tailscaled-amd64 out/tailscaled-arm64 out/tailscaled-386 out/tailscaled-arm
	rm -f out/tailscale-amd64 out/tailscale-arm64 out/tailscale-386 out/tailscale-arm
